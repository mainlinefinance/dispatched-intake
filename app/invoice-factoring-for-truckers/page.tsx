...
export const metadata: Metadata = {
  title: "Invoice factoring for truckers — same-day",
  description:
  ...
  return (
    <div className="landing">
      ...
      <JsonLd payload={financialService({
        ...
        description:
          "Convert broker and shipper invoices to cash in days. Recourse and non-recourse factoring with 1% to 4% fees, no FICO minimum, routed to trucking-specific factors.",
        url: PAGE_URL,
