...
export const metadata: Metadata = {
  title: "Box truck financing — 16ft to 26ft loans",
  description:
    ...
    <div className="landing">
      ...
      <JsonLd
        payload={financialService({
          name: "Box Truck Financing",
          description:
            "Box truck loans from $20K to $120K for last-mile, expediting, and Amazon Relay operators. Panel APR 9% to 18%, FICO from 500, soft-pull match.",
          url: PAGE_URL,
