...
export const metadata: Metadata = {
  title: "Trucking working capital — fuel & payroll fast",
  description:
  ...
  return (
    <div className="landing">
      ...
      <JsonLd payload={financialService({
        name: "Trucking Working Capital",
        description:
          "Working capital for trucking operations: $25K to $250K to cover fuel, payroll, tolls, and slow-month gaps. Soft-pull match, funds same banking day on approval.",
        url: PAGE_URL,
