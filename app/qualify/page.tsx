...
// FAQPage JSON-LD only — no visible FAQ accordion. Per A5 decision: /qualify
// is a conversion page (QualificationCalc owns the chrome) and a visible FAQ
// would dilute completion rate. Schema-only ships rich-result eligibility.
const faqs = [
  {
